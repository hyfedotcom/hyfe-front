...
export function InsightCard({ card }: { card: { value: string } }) {
  return (
    <div className="bg-[#FBF9F2]/40 backdrop-blur-2xl p-6 border border-[#FFF199] w-full space-y-10 md:space-y-20  flex-1 flex flex-col justify-between rounded-[28px]">
