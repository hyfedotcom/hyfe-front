...
export function ResourceCard({
  ...
  return (
    <div
      className={
        "group flex flex-col w-full h-fit hover:bg-activ border-[1.5px] border-border hover:border-primary hover:shadow-hover duration-300 space-y-5 bg-card rounded-[20px] overflow-hidden"
      }
    >
      <Image
        src={cover.url || ""}
      ...
      <div className="px-5  h-full flex flex-col">
        <div className=" h-full flex flex-col">
          <div className="flex mb-4 gap-1 shrink-0">
