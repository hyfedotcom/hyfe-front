  ...
  return (
    <button
      ...
      className={clsx(
        ...
        glass && active
          ? "border-black/20 bg-gradient-to-b from-white/98 via-white/90 to-white/80 text-black shadow-[0_8px_18px_rgba(15,23,42,0.12),0_1px_4px_rgba(255,255,255,0.72)_inset]"
          : "",
        glass && !active
