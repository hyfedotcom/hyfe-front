  ...
  return (
    <button
      ...
      className={clsx(
        ...
        glass && active
          ? "border-black/20 bg-gradient-to-tl from-primary/50 via-white to-white text-black shadow-[0_8px_18px_rgba(15,23,42,0.12),0_1px_4px_rgba(255,255,255,0.72)_inset] py-1!"
          : "",
        glass && !active
