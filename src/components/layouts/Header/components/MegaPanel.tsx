...
export function MegaPanel({
  ...
  return (
    ...
    >
      <div
        className={cx(
          "relative overflow-hidden rounded-[28px] border border-black/[0.14] bg-gradient-to-b from-white/88 via-white/74 to-white/58 shadow-[0_22px_55px_rgba(15,23,42,0.2),0_2px_10px_rgba(255,255,255,0.55)_inset] ring-1 ring-black/[0.06]",
        )}
      >
        <div
          aria-hidden="true"
                  ...
                  <div className="space-y-1">
                    {sec.items.map((it) => {
                      const Icon =
                        ...
                        META_BY_LABEL[it.label as keyof typeof META_BY_LABEL]
                          ?.Icon;
                      return (
                        <NavLink
                          key={it.id}
